...
<div class="tab-content" id="pills-tabContent">
	...
	<div class="tab-pane fade" id="pills-messages" role="tabpanel" aria-labelledby="pills-messages-tab">
		...
		<div class="row">
			...
			<?php
				$um=new UserMessages();
				$messages=$um->getAllMessages($userid,$db);
				$str="<table class='table table-striped'><tr>
					<td>Messages</td>
					<td>Sent By</td>
					<td>Actions</td>
				...
				foreach($messages as $msg)
				{
					$str.="<tr>
						...
						<td>".$msg->authorfname." ".$msg->authorlname."</td>
						<td><button class='btn btn-success'>Reply</button><button class='btn btn-danger'>Delete</button></td>
					</tr>";
				}
				echo $str."</table>";
			?>
