<main id="main">
  ...
  <div class="page-wrapper flex-container">
    <div id="categories" class="flex-container">
      <a href="recipes.php?id=5" class="food-category">
      ...
      <a href="recipes.php?id=6" class="food-category">
      ...
      <a href="recipes.php?id=7" class="food-category">
      ...
      <a href="recipes.php?id=8" class="food-category">
      ...
      <a href="recipes.php?id=9" class="food-category">
      ...
      <a href="recipes.php?id=10" class="food-category">
      ...
      <a href="recipes.php?id=11" class="food-category">
      ...
      <a href="recipes.php?id=12" class="food-category">
